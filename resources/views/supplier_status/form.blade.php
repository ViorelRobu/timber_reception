      ...
      <div class="modal-body">
        <form action="/supplier_status/add" method="POST">
            ...
            <div class="form-group">
                <input type="text" class="form-control" name="name" placeholder="Denumire status" required>
            </div>
            <div class="form-group">
                <input type="text" class="form-control" name="name_en" placeholder="Denumire status EN" required>
            </div>
      </div>
