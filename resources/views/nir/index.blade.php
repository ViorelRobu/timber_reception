...
@section('content_header')
    <h1 class="d-inline"><strong>Lista NIR</strong> - {{ $company_name[0] }} <button id="addCountry" class="btn btn-primary pull-right" data-toggle="modal" data-target="#countriesForm">Adauga NIR</button></h1>
@stop
