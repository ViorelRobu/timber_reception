...
@yield('title_postfix', config('adminlte.title_postfix', ''))</title>
    ...
    @if(config('adminlte.plugins.datatables'))
        ...
        <link rel="stylesheet" href="{{ asset('vendor/adminlte/vendor/datatables/css/dataTables.bootstrap4.min.css') }}">
...
@if(config('adminlte.plugins.datatables'))
    <!-- DataTables with bootstrap renderer -->
    <script src="{{ asset('vendor/adminlte/vendor/datatables/js/datatables.min.js') }}"></script>
