...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::group(['middleware' => 'verify.company'], function () {
        ...
        Route::prefix('articles')->group(function () {
            ...
            Route::get('/history', 'ArticlesController@fetchHistory')->name('articles.history')->middleware('can:admin');
        ...
        Route::prefix('species')->group(function () {
            ...
            Route::get('/history', 'SpeciesController@fetchHistory')->name('species.history')->middleware('can:admin');
        ...
        Route::prefix('moisture')->group(function () {
            ...
            Route::get('/history', 'MoistureController@fetchHistory')->name('moisture.history')->middleware('can:admin');
        ...
        Route::prefix('reception')->group(function () {
            ...
            Route::get('/history', 'ReceptionCommitteeController@fetchHistory')->name('committee.history')->middleware('can:admin');
            Route::get('/members', 'ReceptionCommitteeController@index')->name('reception.index')->middleware('can:admin');
            Route::get('/members/history', 'ReceptionCommitteeController@fetchReceptionCommitteeHistory')->name('reception.history')->middleware('can:admin');
        ...
        Route::prefix('packaging')->group(function () {
            ...
            Route::get('/sub/history', 'PackagingController@fetchHistorySub')->name('packaging_sub.history')->middleware('can:admin');
            ...
            Route::get('/supplier/history', 'PackagingController@fetchHistoryPackagingPerSupplier')->name('packaging_supplier.history')->middleware('can:admin');
        ...
        Route::prefix('claims')->group(function() {
            ...
            Route::post('/reactivate', 'ClaimsController@reactivate')->middleware('can:superadmin');
            Route::get('/fetch', 'ClaimsController@fetch')->name('claims.fetch')->middleware('can:user');
            Route::get('/export', 'ClaimsController@export')->middleware('can:user');
            Route::get('/fetch/history', 'ClaimsController@fetchHistory')->name('claims.history')->middleware('can:admin');
            Route::get('/{claim}/print/{language}', 'ClaimsController@print')->middleware('can:user');
            Route::patch('/{claim}/update', 'ClaimsController@update')->middleware('can:user');
            Route::patch('/{claim}/updateStatus', 'ClaimsController@updateStatus')->middleware('can:user');
